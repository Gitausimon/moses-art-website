      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-12">
        ...
        <div className="lg:col-span-4 order-1 lg:order-2">
            <div className="w-full aspect-[3/4] bg-[#111] flex items-center justify-center relative overflow-hidden">
                <img src="/njuguna-picture.jpg" alt="Moses Njuguna" className="absolute inset-0 w-full h-full object-cover grayscale hover:grayscale-0 transition-all duration-700 z-10" />
            </div>
        </div>
